    ...
    <>
      ...
      <main className={styles.main}>
        ...
        <div className={styles.grid}>
          ...
          {  // TODO Alterar deezer_auth_state
            ( cookies.current && cookies.current.access_token && cookies.current.access_token_deezer ) ? 
              (
      ...
      (
        <Notification 
          ...
          closeButtonProps={{ 'aria-label': 'Hide notification', title: 'Hide notification'}}
